      ...
      <div className="md:w-1/2">
        <div className="border-2 p-10 rounded-md border-[#999]">
          <form>
            ...
            <button class="btn w-full bg-orange border-2 text-light font-semibold text-xl hover:border-dark hover:text-dark">Sign up</button>

          </form>

          <p className="text-center my-5 text-xl font-semibold">Or Sign Up With</p>
          ...
          <p className="text-center font-semibold text-xl">Already have an account?  <Link className="text-orange" to={'/login'}>Login</Link></p>
        </div>
      </div>
    </div>
    );
